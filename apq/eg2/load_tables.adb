-- $Id: load_tables.adb,v 1.2 2003/08/26 04:15:09 wwg Exp $
-- Warren W. Gay VE3WWG
--
...
package body Load_Tables is
   ...
   procedure Load_Passwd_Table(C : in out Root_Connection_Type'Class) is
   ...
   begin
      ...
      Append_Line(Q, "  DIR         VARCHAR(255) NOT NULL,");
      Append_Line(Q, "  SHELL       VARCHAR(255) NOT NULL,");
   ...
   procedure Load_Group_Table(C : in out Root_Connection_Type'Class) is
      Q :   Root_Query_Type'Class := New_Query(C);
      Tr :  Root_Query_Type'Class := Q;
   begin
...
-- End $Source: /home/cvs/ada/apq/eg2/load_tables.adb,v $
