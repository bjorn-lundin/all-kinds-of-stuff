...
package SDL2.Video is
   ...
   pragma Import (C, Enable_Screen_Saver, "SDL_EnableScreenSaver");
     
   procedure Disable_Screen_Saver ;
   pragma Import (C, Disable_Screen_Saver, "SDL_DisableScreenSaver");
   ...
   procedure Finalise ;
   pragma Import (C, Finalise, "SDL_VideoQuit");
