...
package SDL2.Video.Windows is
   ...
   procedure Get_Display_Mode (Self : in Window; Mode : out SDL2.Video.Displays.Mode);
   procedure Set_Display_Mode (Self : in out Window; Mode : in SDL2.Video.Displays.Mode);

   function Get_Flags (Self : in Window) return Window_Flags;

   function From_ID (Window_ID : in ID) return Window;

   procedure Get_Gamma_Ramp (Self : in Window; Red, Green, Blue : out SDL2.Video.Pixel_Formats.Gamma_Ramp);
   procedure Set_Gamma_Ramp (Self : in out Window; Red, Green, Blue : in SDL2.Video.Pixel_Formats.Gamma_Ramp);
   ...
   function Pixel_Format (Self : in Window) return SDL2.Video.Pixel_Formats.Pixel_Format with
     Inline => True;
  ...
  -- function Get_Surface (Self : in Window) return SDL2.Video.Surfaces.Surface;
   function Get_Surface_Pointer (Self : in Window) return SDL2.Video.Surfaces.Surface_Pointer;
   ...
   procedure Set_Icon (Self : in out Window; Icon : in SDL2.Video.Surfaces.Surface) with
     Inline => True;

   procedure Update_Surface (Self : in Window);

   procedure Update_Surface_Rectangles (Self : in Window; Rectangles : SDL2.Video.Rectangles.Rectangle_Arrays);
