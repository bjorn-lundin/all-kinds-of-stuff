...
package body SDL2.Video.Windows is
  ...
  -- use type Windows_Pointer;
   ...
   procedure Finalize (Self : in out Window) is
      procedure SDL_Destroy (W : in Windows_Pointer);
   ...
   function Get_Brightness (Self : in Window) return Brightness is
      function SDL_Get_Brightness (W : in Windows_Pointer) return C.C_float ;
   ...
   procedure Set_Brightness (Self : in out Window; How_Bright : in Brightness) is
      function SDL_Set_Brightness (W : in Windows_Pointer; B : in C.C_float) return C.int;
   ...
   function Get_Data (Self : in Window; Name : in String) return User_Data_Access is
      function SDL_Get_Window_Data (W    : in Windows_Pointer;
   ...
   function Set_Data (Self : in out Window; Name : in String; Item : in User_Data_Access) return User_Data_Access is
      function SDL_Set_Window_Data (W         : in Windows_Pointer;
   ...
   function Display_Index (Self : in Window) return Positive is
      function SDL_Get_Window_Display_Index (W : in Windows_Pointer) return C.int ;
   ...
   procedure Get_Display_Mode (Self : in Window; Mode : out SDL2.Video.Displays.Mode) is
      function SDL_Get_Window_Display_Mode (W : in Windows_Pointer;
   ...
   procedure Set_Display_Mode (Self : in out Window; Mode : in SDL2.Video.Displays.Mode) is
      function SDL_Set_Window_Display_Mode (W : in Windows_Pointer;
   ...
   function Get_Flags (Self : in Window) return Window_Flags is
      function SDL_Set_Window_Display_Mode (W : in Windows_Pointer) return Window_Flags ;
   ...
   function From_ID (Window_ID : in ID) return Window is
      function SDL_Get_Window_From_ID (W : in ID) return Windows_Pointer ;
   ...
   procedure Get_Gamma_Ramp (Self : in Window; Red, Green, Blue : out SDL2.Video.Pixel_Formats.Gamma_Ramp) is
      function SDL_Get_Window_Gamma_Ramp (W       : in Windows_Pointer;
   ...
   procedure Set_Gamma_Ramp (Self : in out Window; Red, Green, Blue : in SDL2.Video.Pixel_Formats.Gamma_Ramp) is
      function SDL_Set_Window_Gamma_Ramp (W       : in Windows_Pointer;
   ...
   function Is_Grabbed (Self : in Window) return Boolean is
      function SDL_Get_Window_Grab (W : in Windows_Pointer) return SDL_Bool ;
   ...
   procedure Set_Grabbed (Self : in out Window; Grabbed : in Boolean := True) is
      procedure SDL_Set_Window_Grab (W : in Windows_Pointer; G : in SDL_Bool) ;
   ...
   function Get_ID (Self : in Window) return ID is
      function SDL_Get_Window_ID (W : in Windows_Pointer) return ID ;
   ...
   function Get_Maximum_Size (Self : in Window) return Sizes is
      procedure SDL_Get_Window_Maximum_Size (Win : in Windows_Pointer; W, H : out C.int) ;
   ...
   procedure Set_Maximum_Size (Self : in out Window; Size : in Sizes) is
      procedure SDL_Set_Window_Maximum_Size (Win : in Windows_Pointer; W, H : in C.int) ;
   ...
   function Get_Minimum_Size (Self : in Window) return Sizes is
      procedure SDL_Get_Window_Minimum_Size (Win : in Windows_Pointer; W, H : out C.int) ;
   ...
   procedure Set_Minimum_Size (Self : in out Window; Size : in Sizes) is
      procedure SDL_Set_Window_Minimum_Size (Win : in Windows_Pointer; W, H : in C.int) ;
   ...
   function Pixel_Format (Self : in Window) return SDL2.Video.Pixel_Formats.Pixel_Format is
      function SDL_Get_Window_Pixel_Format (W : in Windows_Pointer)
   ...
   function Get_Position (Self : in Window) return Positions is
      procedure SDL_Get_Window_Position (W : in Windows_Pointer; X, Y : out C.int) ;
   ...
   procedure Set_Position (Self : in out Window; Position : Positions) is
      procedure SDL_Set_Window_Position (W : in Windows_Pointer; X, Y : in C.int) ;
   ...
   function Get_Size (Self : in Window) return Sizes is
      procedure SDL_Get_Window_Size (Win : in Windows_Pointer; W, H : out C.int) ;
   ...
   procedure Set_Size (Self : in out Window; Size : in Sizes) is
      procedure SDL_Set_Window_Size (Win : in Windows_Pointer; W, H : in C.int) ;
   ...
   function Get_Surface_Pointer (Self : in Window) return SDL2.Video.Surfaces.Surface_Pointer is
      function SDL_Get_Window_Surface (W : in Windows_Pointer) return  SDL2.Video.Surfaces.Surface_Pointer ;
   ...
   function Get_Title (Self : in Window) return Ada.Strings.UTF_Encoding.UTF_8_String is
      function SDL_Get_Window_Title (W : in Windows_Pointer) return C.Strings.Chars_Ptr ;
   ...
   procedure Set_Title (Self : in Window; Title : in Ada.Strings.UTF_Encoding.UTF_8_String) is
      procedure SDL_Set_Window_Title (W : in Windows_Pointer; C_Str : in C.Char_Array) ;
   ...
   procedure Hide (Self : in Window) is
      procedure SDL_Hide_Window (W : in Windows_Pointer) ;
   ...
   procedure Show (Self : in Window) is
      procedure SDL_Show_Window (W : in Windows_Pointer) ;
   ...
   procedure Maximise (Self : in Window) is
      procedure SDL_Maximise_Window (W : in Windows_Pointer) ;
   ...
   procedure Minimise (Self : in Window) is
      procedure SDL_Minimise_Window (W : in Windows_Pointer) ;
   ...
   procedure Raise_And_Focus (Self : in Window) is
      procedure SDL_Raise_Window (W : in Windows_Pointer) ;
   ...
   procedure Restore (Self : in Window) is
      procedure SDL_Restore_Window (W : in Windows_Pointer) ;
   ...
   procedure Set_Mode (Self : in out Window; Flags : in Full_Screen_Flags) is
      function SDL_Window_Full_Screen (W : in Windows_Pointer;
   ...
   procedure Set_Icon (Self : in out Window; Icon : in SDL2.Video.Surfaces.Surface) is
      procedure SDL_Set_Window_Icon (W : in Windows_Pointer; I : SDL2.Video.Surfaces.Surface_Pointer) ;
   ...
   procedure Update_Surface (Self : in Window) is
      function SDL_Update_Window_Surface (W : in Windows_Pointer) return C.int ;
   ...
   procedure Update_Surface_Rectangles (Self : in Window; Rectangles : SDL2.Video.Rectangles.Rectangle_Arrays) is
      function SDL_Update_Window_Surface_Rects (W : in Windows_Pointer;
   ...
   function Get_Internal (Self : in Window) return Windows_Pointer is
   begin
     ...
     (Win    : in out Window;
      ...
      function SDL_Create
        (Title      : C.Strings.Chars_Ptr;
         X, Y, W, H : in C.int;
         F          : in Window_Flags) return Windows_Pointer ;
   ...
   procedure Create (Win : in out Window; Native : in Native_Window) is
      function SDL_Create_Window_From (Native : Native_Window) return Windows_Pointer with
