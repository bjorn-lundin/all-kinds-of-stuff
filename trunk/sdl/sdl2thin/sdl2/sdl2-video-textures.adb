...
package body SDL2.Video.Textures is
   ...
   procedure Destroy (Self : in out Texture) is
      procedure SDL_Destroy_Texture (T : in SDL2.Texture_Pointer);
   ...
   function Get_Alpha (Self : in Texture) return SDL2.Video.Palettes.Color_Component is
      function SDL_Get_Texture_Alpha_Mod (T     : in SDL2.Texture_Pointer;
                                          Alpha : access SDL2.Video.Palettes.Color_Component) return C.Int ;
      pragma Import(C, SDL_Get_Texture_Alpha_Mod,  "SDL_GetTextureAlphaMod");
      Data   : aliased SDL2.Video.Palettes.Color_Component;
   ...
   procedure Set_Alpha (Self : in out Texture; Alpha : in SDL2.Video.Palettes.Color_Component) is
      function SDL_Set_Texture_Alpha_Mod (T     : in SDL2.Texture_Pointer;
                                          Alpha : in SDL2.Video.Palettes.Color_Component) return C.Int ;
   ...
   function Get_Modulate_Color (Self : in Texture) return SDL2.Video.Palettes.RGB_Color is
      function SDL_Get_Texture_Color_Mod (T       : in SDL2.Texture_Pointer;
                                          R, G, B : access SDL2.Video.Palettes.Color_Component) return C.Int ;
      pragma Import(C, SDL_Get_Texture_Color_Mod,  "SDL_GetTextureColorMod");
      Red,Green,Blue : aliased SDL2.Video.Palettes.Color_Component;
      Data   : aliased SDL2.Video.Palettes.RGB_Color;
   ...
   begin
      ...
      Data := (Red,Green,Blue);
      return Data;
   end Get_Modulate_Color;

   procedure Set_Modulate_Color (Self : in out Texture; Color : in SDL2.Video.Palettes.RGB_Color) is
      function SDL_Set_Texture_Color_Mod (T       : in SDL2.Texture_Pointer;
                                          R, G, B : in SDL2.Video.Palettes.Color_Component) return C.Int ;
      pragma Import(C, SDL_Set_Texture_Color_Mod,  "SDL_SetTextureColorMod");

      Result : C.Int := SDL_Set_Texture_Color_Mod (Self.Pointer, Color.Red, Color.Green, Color.Blue);
   begin
      if Result /= Success then
         raise  SDL_Error with SDL2.Error.Get;
      end if;
   end Set_Modulate_Color;
   ...
   procedure Query(Self   : in out Texture; 
      ...
      function SDL_Query_Texture (T       : SDL2.Texture_Pointer;
                                  ...
                                  A, W, H : access Interfaces.C.Int) return C.Int ;
   ...
   function Get_Pointer (Self : in Texture) return SDL2.Texture_Pointer is
   begin
      return Self.Pointer;
   end Get_Pointer;
