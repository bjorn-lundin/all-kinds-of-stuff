...
package body SDL2.Video.Rectangles is
   ...
   function Enclose (Points : in Point_Arrays; Clip : in Rectangle; Enclosed : out Rectangle) return Boolean is
      function SDL_Enclose_Points (P    : access Point_Arrays;
                                   L    : in C.int;
                                   Clip : access Rectangle;
                                   R    : access Rectangle) return SDL_Bool ;
      ...
      Result : SDL_Bool := SDL_Enclose_Points (Tmp_Points'access, 
                                               C.int (Points'Length), 
                                               Tmp_Clip'access, 
                                               Tmp_Enclosed'access);
   begin
   ...
   function Has_Intersected (A, B : in Rectangle) return Boolean is
      function SDL_Has_Intersection (A, B : access Rectangle) return SDL_Bool ;
   ...
   function Intersects (A, B : in Rectangle; Intersection : out Rectangle) return Boolean is
      function SDL_Has_Intersection (A, B , R : access Rectangle) return SDL_Bool ;
   ...
   function Clip_To (Clip_Area : in Rectangle; Line : in out Line_Segment) return Boolean is
      function SDL_Intersect_Rect_And_Line (R : access Rectangle; X1, Y1, X2, Y2 : access C.int) return SDL_Bool ;
   ...
   function Union (A, B : in Rectangle) return Rectangle is
      procedure SDL_Union_Rect (A, B : access Rectangle; R : access Rectangle) ;
