...
package SDL2.Video.Pixels is
   ...
   type ARGB_8888 is record
         Alpha : SDL2.Video.Palettes.Color_Component;
         Red   : SDL2.Video.Palettes.Color_Component;
         Green : SDL2.Video.Palettes.Color_Component;
         Blue  : SDL2.Video.Palettes.Color_Component;
   end record ;
   ...
   package ARGB_8888_Access is new Interfaces.C.Pointers
     (Index              => Positive,
      ...
      Default_Terminator => ARGB_8888'(others => SDL2.Video.Palettes.Color_Component'First));
