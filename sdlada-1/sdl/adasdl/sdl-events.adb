...
package body SDL.Events is
   ...
   --  ======================================
   function Poll_Event return C.int is
      function CheckPollEvent (event : Event_ptr) return C.int;
      pragma Import (C, CheckPollEvent, "SDL_PollEvent");
   begin
      return CheckPollEvent (null);
   end Poll_Event;

   --  ======================================
   function Wait_Any_Event return C.int is
   begin
